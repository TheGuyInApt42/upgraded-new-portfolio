<!-- Navbar (tablets + desktops) -->
<nav role="navigation" class="hidden px-8 md:flex md:justify-center md:gap-x-32 md:mt-4 xl:max-w-screen-2xl xl:mx-auto">
	<!-- Logo -->
	<div>
		<a href="/">
			<svg
	...
	<!-- Menu -->
	<div
		class="list-none flex justify-center items-center gap-x-8 text-xs opacity-60 font-medium xl:text-sm xl:gap-x-12 xl:pl-10"
	>
		<!-- Menu Item -->
		<div class="inline-block relative">
			<li class="relative"><a href="#testimonials" class="inline-block h-full w-full">Testimonials</a></li>
		</div>

		<!-- Menu Item -->
		<div class="inline-block relative">
			<li class="relative"><a href="#experience" class="inline-block h-full w-full">Experience</a></li>
		</div>

		<!-- Menu Item -->
		<div class="inline-block relative">
			<li class="relative"><a href="#" class="inline-block h-full w-full">Contact</a></li>
		</div>
	</div>
