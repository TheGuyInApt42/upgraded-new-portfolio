	...
	const services = [
		{
			...
			text:
				'I can create your web site from any design that you desire and it will look great on both mobile phones as well on a desktop. ',
			imageAlt: 'Notebook with design',
			imageSrc: 'https://res.cloudinary.com/blackgandalf/image/upload/v1646855349/GWC/services/design_uhxstl.jpg',
			alignment: 'left',
			interesting:
		...
		},
		{
			...
			imageSrc:
				'https://res.cloudinary.com/blackgandalf/image/upload/v1646855349/GWC/services/digital-marketing_davhg1.jpg',
			alignment: 'right',
...

		{
			...
			imageSrc:
				'https://res.cloudinary.com/blackgandalf/image/upload/v1646857337/GWC/services/437226-JavaScript-code-web_development-748x421_ikcoeo.jpg',
			alignment: 'left',
		...
		},
		{
			...
			tagline: 'Expand your audience with focused social media campaigns and ads as well as email marketing.',
			text:
				'I can create a web presence across social media platforms such as Instagram and Facebook. I can also do newsletters and email marketing for you',
			imageAlt: 'Phone with social media apps on screen',
			imageSrc:
				'https://res.cloudinary.com/blackgandalf/image/upload/v1646855349/GWC/services/social-media_uj5z8e.jpg',
			alignment: 'right',
			interesting:
			...
			>
				...
				<div class="pt-8 mx-auto lg:w-1/3 lg:py-24 dark:text-white">
					...
					<p class="mt-4 text-sm opacity-75 md:pr-4 lg:mt-8 md:text-lg lg:text-2xl"
						>Here I show you what I can offer you for a glimpse into what will make you successful.</p
					>
				</div>

				<!-- Services -->
				<div class="pt-12 lg:pt-0 dark:text-white">
					<h2 class="inline-block text-xs italic font-light uppercase opacity-75 lg:text-sm lg:pb-4">
						Great Services
					</h2>
					...
					<div class="grid gap-y-4 md:gap-y-0 md:grid-cols-2 md:gap-x-12 lg:gap-y-12">
						...
						<div>
							...
							<h3 class="mb-2 -mt-2 text-sm font-medium lg:text-base lg:mt-0"
								><b class="font-black">Designs</b> that impress</h3
							>
						</div>
						...
						<div>
							...
							<!-- Heading -->
							<h3 class="mb-2 -mt-2 text-sm font-medium lg:text-base lg:mt-0"
								><b class="font-black">Build </b> Features that matter</h3
							>
						</div>
